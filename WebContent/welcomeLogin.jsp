        ...
        <div id="theRealStuff">
            <div id="loginStuff">
                <div id="login" class="write content writeClick" style="font-size:medium">
                    <b onclick="showTab2()" id="tab1Font" class="loginFont loginFontSelected">Login</b><b onclick="showTab1()" id="tab2Font" class="loginFont">Register</b>
                </div>
                <div class="content contentNoHover">
                	<div id="tab2" class="nodisplay center">
                	    <br>
                		<form action="register" method="post">
						<input type="text" class="uInput" name="uname" placeholder="username">
						<br><br>
						<input type="password" class="uInput" name="passwd" placeholder="password">
						<br><br>
						<input type="password" class="uInput" name="passwd2" placeholder="confirm password">
						<br><br>
